...
logsRouter.get("/:id/logs", async (req, res): Promise<void> => {
...
logsRouter.post("/:id/logs", async (req, res): Promise<void> => {
...
logsRouter.delete("/:id/logs/:logId", async (req, res): Promise<void> => {
