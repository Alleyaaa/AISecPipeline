  ...
  vaul@1.1.2(@types/react-dom@18.3.7(@types/react@18.3.30))(@types/react@18.3.30)(react-dom@18.3.1(react@18.3.1))(react@18.3.1):
    dependencies:
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-4 gap-3">
        {[
          ...
          { label: "Artifacts Collected", value: artifacts.length, color: "text-emerald-400", desc: "Suspicious" },
