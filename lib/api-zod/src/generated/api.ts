...
export const GetSessionResponse = zod.object({
  ...
  "verdict": zod.union([zod.literal('true_positive'),zod.literal('false_positive'),zod.literal('need_investigation'),zod.literal(null)]).nullish(),
  "detailedFindings": zod.string().nullish(),
